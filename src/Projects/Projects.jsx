    ...
    <div id='portfolio' className='container-fluid'>
      <div className='row'>
        <div className='rk col-xl-7 col-md-7 col-sm-7'>
          ...
          <p data-aos="fade-up" className='work'>Deployed scalable travel, event and telemedicine web and hybrid web apps using React SPA and PWA.
            Collaborated in 40+ projects with 10+ clients all around the world.</p>
        </div>
